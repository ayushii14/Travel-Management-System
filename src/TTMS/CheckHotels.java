...
JLabel caption;
    public void run() {
        ...
        String[] text=new String[]{  "JW Mariott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Radisson Blue Hotel","Classio Hotel", "The Bay Club" ,"Bleeze Blow Hotel","The Tourist Palace", "Avari Hotel","Scandic Hotel" };
    ...
    CheckHotels() {
        ...
        Image j1 = null, j2 = null, j3 = null, j4 = null, j5 = null, j6 = null, j7 = null, j8 = null, j9 = null,
                j10 = null;// for i2/ seconf line under for loop;to put the imageicon in image
        ...
        for (int i = 0; i <= 9; i++) {
            image[i] = new ImageIcon(ClassLoader.getSystemResource("src/icons/hotel" + (i + 1) + ".jpg"));
